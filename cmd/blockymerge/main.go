...
func printUsage() {
	...
	fmt.Println("  -hold-offset Extra translation for the held item in the hand's frame, units as x,y,z")
	fmt.Println("  -hold-scale  Extra scale multiplier for the held item (0 = the item's own scale)")
	fmt.Println("  -hide        Hide a node and everything under it (e.g. Head); repeatable")
